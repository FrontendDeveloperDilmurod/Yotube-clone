...
const Sidibar = () => {
  ...
  return (
    <div
      className={`mt-16 pb-12 top-16 left-0 h-screen p-4 overflow-y-auto transition-transform transform sticky ${sidebar ? "w-60" : "w-20"} hover:scrollbar-thin hover:scrollbar-thumb-gray-400 hover:scrollbar-track-gray-100`}
    >
      <div
        className={`flex gap-4 items-center p-1 rounded-lg cursor-pointer hover:bg-gray-200 ${category === 12 ? " bg-gray-300" : ""}`}
        onClick={() => setCategory(12)}
      >
        <Link to="/" className="flex items-center gap-4">
          <img src={home} alt="home" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={game_icon} alt="game_icon" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={automobiles} alt="automobiles" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={sports} alt="sports" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={entertamen} alt="entertainment" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={teach} alt="technology" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={music} alt="music" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={blogs} alt="blogs" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      >
        <img src={news} alt="news" className={`w-${sidebar ? "6" : "8"} sm:w-8 md:w-8`} />
      ...
      <div className="mt-8">
        ...
        <div className="mt-4">
          <Link to={'/channnels'}>
            <div
              className={`flex gap-4 items-center p-1 mt-3 rounded-lg cursor-pointer hover:bg-gray-200 ${category === 262 ? " bg-gray-300" : ""}`}
              onClick={() => setCategory(262)}
            >
              <img src={developer} alt="developer" className="w-10 h-10 rounded-full" />
